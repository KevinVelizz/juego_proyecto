...
class Fruta:
    def __init__(self,x,y,frame_rate_ms,is_move) -> None:
        self.stay = Auxiliar.getSurfaceFromSpriteSheet(PATH_IMAGE + "Items/Fruits/Apple.png",17,1,False,1,1)
        self.frame = 0
    ...
    def update(self,delta_ms,platform_list,pos_xy):
