...
class FormLevels(Form):
    def __init__(self, name, master_surface, x, y, w, h, color_border, active, image_background=None, color_background=None):
        ...
        self.txt2 = TextBox(master=self,x=705,y=20,w=170,h=150,color_background=None,color_border=None,image_background="PIXEL ADVENTURE/Recursos/Menu/Buttons/imagen_levels.png",text=None,font="Arial",font_size=40,font_color=C_BLACK)

        self.txt3 = TextBox(master=self,x=1080,y=20,w=170,h=150,color_background=None,color_border=None,image_background="PIXEL ADVENTURE/Recursos/Menu/Buttons/imagen_levels.png",text=None,font="Arial",font_size=40,font_color=C_BLACK)

        self.lista_widget = [self.txt1,self.txt2,self.txt3,self.level1,self.level2,self.level3]
