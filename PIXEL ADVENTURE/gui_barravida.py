...
class BarraVida(Widget):
    def __init__(self,master,x=0,y=0,w=200,h=50,color_background=C_GREEN,color_border=C_RED,image_background=None,color_vida=C_WHITE,image_progress=None,value=1,value_max=5):
