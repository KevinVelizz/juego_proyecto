...
class FormRanking(Form):
    def __init__(self, name, master_surface, x, y, w, h, color_border, active, image_background=None, color_background=None):
        ...
        self.text_score = 0
        self.puntos_lvl = TextBox(master=self,x=100,y=0,w=170,h=150,color_background=None,color_border=None,image_background=None,text= self.text_score,font="Arial",font_size=40,font_color=C_BLACK)
        ...
        self.lista_widget = [self.puntos_lvl,self.atras]
