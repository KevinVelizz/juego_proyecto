...
class Player:
    def __init__(self,x,y,speed_walk,speed_run,move_rate_ms,gravity,jump,vida,screen) -> None:
        self.stay_r = Auxiliar.getSurfaceFromSpriteSheet(PATH_IMAGE + "Main Characters/Mask Dude/Idle (32x32).png",11,1,False,1,2)
        self.stay_l = Auxiliar.getSurfaceFromSpriteSheet(PATH_IMAGE + "Main Characters/Mask Dude/Idle (32x32).png",11,1,True,1,2)
        self.walk_r = Auxiliar.getSurfaceFromSpriteSheet(PATH_IMAGE + "Main Characters/Mask Dude/Run (32x32).png",12,1,False,1,2)
        self.walk_l = Auxiliar.getSurfaceFromSpriteSheet(PATH_IMAGE + "Main Characters/Mask Dude/Run (32x32).png",12,1,True,1,2)
        self.jump_r = Auxiliar.getSurfaceFromSpriteSheet(PATH_IMAGE + "Main Characters/Mask Dude/Jump (32x32).png",1,1,False,1,2)
        self.jump_l = Auxiliar.getSurfaceFromSpriteSheet(PATH_IMAGE + "Main Characters/Mask Dude/Jump (32x32).png",1,1,True,1,2)
        self.fall_r = Auxiliar.getSurfaceFromSpriteSheet(PATH_IMAGE + "Main Characters/Mask Dude/Fall (32x32).png",1,1,False,1,2)
        self.fall_l = Auxiliar.getSurfaceFromSpriteSheet(PATH_IMAGE + "Main Characters/Mask Dude/Fall (32x32).png",1,1,True,1,2)
        self.hit_r = Auxiliar.getSurfaceFromSpriteSheet(PATH_IMAGE + "Main Characters/Mask Dude/Hit (32x32).png",7,1,False,1,2)
        self.hit_l = Auxiliar.getSurfaceFromSpriteSheet(PATH_IMAGE + "Main Characters/Mask Dude/Hit (32x32).png",7,1,True,1,2)
        self.jump_y = jump
        self.move_x = 0
        self.move_y = 0
        self.frame = 0
