...
class FormPauseLvl(Form):
    def __init__(self, name, master_surface, x, y, w, h, color_border, active, image_background=None, color_background=None):
        ...
        self.txt2 = TextBox(master=self,x=80,y=-20,w=250,h=150,color_background=None,color_border=None,image_background="PIXEL ADVENTURE/Recursos/Menu/Buttons/header.png",text=None,font="Arial",font_size=40,font_color=None)

        self.reanudar = Button(master=self,x=110,y=150,w=150,h=60,color_background=None,color_border=None,image_background="PIXEL ADVENTURE/Recursos/Menu/Buttons/boton_play.png",on_click=self.on_click_boton1,on_click_param="level_uno",text=None,font="Verdana",font_size=30,font_color=C_WHITE)
