...
class FormOptions(Form):
    def __init__(self, name, master_surface, x, y, w, h, color_border, active, image_background=None, color_background=None):
        ...
        self.on = "PIXEL ADVENTURE/Recursos/Menu/96.png"
        self.off = "PIXEL ADVENTURE/Recursos/Menu/95.png"
        ...
        #volumen
        self.subir = Button(master=self,x=890,y=250,w=50,h=50,color_background=None,color_border=None,image_background="PIXEL ADVENTURE/Recursos/Menu/Buttons/Next.png",on_click=self.on_click_subir_vol,on_click_param="Options",text=None,font="Verdana",font_size=30,font_color=C_WHITE)
        self.bajar = Button(master=self,x=600,y=250,w=50,h=50,color_background=None,color_border=None,image_background="PIXEL ADVENTURE/Recursos/Menu/Buttons/Previous.png",on_click=self.on_click_bajar_vol,on_click_param="Options",text=None,font="Verdana",font_size=30,font_color=C_WHITE)
